...
# Initial the map
# Add the coordenates of ea launch point
c=launch_sites_df.iloc[0,1],launch_sites_df.iloc[0,2]
c1=launch_sites_df.iloc[1,1],launch_sites_df.iloc[1,2]
c2=launch_sites_df.iloc[2,1],launch_sites_df.iloc[2,2]
c3=launch_sites_df.iloc[3,1],launch_sites_df.iloc[3,2]
site_map = folium.Map(c, zoom_start=5)

# For each launch site, add a Circle object based on its coordinate (Lat, Long) values. In addition, add Launch site name as a popup label
circle = folium.Circle(c, radius=1000, color='#d35400', fill=True).add_child(folium.Popup('CCAFS LC-40'))
circle1= folium.Circle(c1, radius=1000, color='#d35400', fill=True).add_child(folium.Popup('CCAFS SLC-40'))
circle2= folium.Circle(c2, radius=1000, color='#d35400', fill=True).add_child(folium.Popup('KSC LC-39A'))
circle3= folium.Circle(c3, radius=1000, color='#d35400', fill=True).add_child(folium.Popup('VAFB SLC-4E'))
...
def checker (Class):
    if Class==1:
        ...
        return 'red'
spacex_df['marker_color']=spacex_df['class'].apply(checker)
spacex_df.head()
